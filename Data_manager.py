...
import tifffile
from cellpose_plus import transforms
import cv2

class NucleiDataset(Dataset):
    def __init__(self, root_dir, resize_to=None, verbose=False):
    ...
    def __getitem__(self, idx):
        ...
        # if self.verbose:
        #     mask_px = np.count_nonzero(cellprob)
        #     print(f"[{img_name}] mask_pixels={mask_px} (NO FLOW MODE)")
